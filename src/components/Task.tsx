...
function Task({text, isComplete, index, onDeleteTask, onCompleteTask}: TaskProps) {
  ...
  return(
    <div className="flex flex-col justify-center items-center w-full">
      <div className="flex justify-between p-5 bg-gray500 border-2 border-gray400 items-center w-3/5 mt-10 rounded-lg text-white">
        ...
        <div>
          <button onClick={() => onDeleteTask(index)} className='hover:bg-gray400 rounded-lg'>
            <span>
              <svg width="32" height="32" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className='text-gray300 hover:text-red300'>
